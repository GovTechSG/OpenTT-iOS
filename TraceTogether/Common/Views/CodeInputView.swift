...
//  OpenTraceTogether
//
//  Modified from https://github.com/mnvoh/DigitInputView, which is licensed under MIT licenseimport UIKit
...
open class CodeInputView: UIView {
    ...
    */
    ...
    open var borderCustomColor =  UIColor(red: 224/255, green: 224/255, blue: 224/255, alpha: 1.0).cgColor {
    ...
    open var nextDigitBorderColor = UIColor(hexString: "a4a4a4").cgColor {
    ...
    */
    ...
    override open func layoutSubviews() {
        ...
        let fontSize = characterHeight * 0.6
    ...
    fileprivate func setup() {
        ...
        for i in 0..<numberOfDigits {
            ...
            label.layer.borderColor = i == 0 ? nextDigitBorderColor : borderCustomColor
            label.layer.borderWidth = i == 0 ? 2 : 1
    ...
    */
    fileprivate func didChange(_ backspaced: Bool = false) {
        ...
        if labels.count > 0, nextIndex < labels.count + 1 {
            ...
            labels[nextIndex - 1].layer.borderColor = nextDigitBorderColor
            labels[nextIndex - 1].layer.borderWidth = 2
            if nextIndex - 2 >= 0 {
                labels[nextIndex - 2].layer.borderWidth = 1
                labels[nextIndex - 2].layer.borderColor = borderCustomColor

            }
            if nextIndex < labels.count {
                labels[nextIndex].layer.borderWidth = 1
                labels[nextIndex].layer.borderColor = borderCustomColor
            }
        } else {
            delegate?.codeDidFinish(codeInputView: self)
            labels.last!.layer.borderColor = borderCustomColor
        }
